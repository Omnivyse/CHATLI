              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-primary dark:bg-primary-dark text-primary-dark dark:text-foreground-dark rounded-lg hover:bg-primary/90 dark:hover:bg-primary-dark/90 transition-colors"
                  >
